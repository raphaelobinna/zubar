  ...
  return (
    <>
        ...
        <div className='navbar'>
          <Link to='#' className='menu_buger'>
            <img onClick={showSidebar} src="asset/img/icons/hammerburger.svg" alt="hammer" /> 
          </Link>
        </div>
          ...
          <ul className='nav-menu-items' onClick={showSidebar}>
            <li className='navbar-toggle'>
              <Link to='#' className='menu-bars'>
                <img src="asset/img/icons/times.svg" alt="times" />
              </Link>
            </li>
                <Link to="/home">   <li> 
